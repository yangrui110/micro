...
$(function(){
   // 刷新iframe操作
    ...
    //右侧小功能-->刷新
    $("#larry-body .layui-nav-child .refresh").on('click',function(){
    	var id=$(".layui-tab-title .layui-this .layui-tab-close").attr("data-id");
    	//$(".layui-show")
    	//alert(1);
    	$("#larry-body .layui-tab-content").children('.layui-tab-item').each(function(i){
    		if($(this).hasClass("layui-show")){
    			 $(this).children('iframe')[0].contentWindow.location.reload(true);
    			//alert(true);
    		}
